...
alert('Codigo copiado! A menos que o seu navegador nao esteja usando o Flash 10');}}
...
{var wnd=window.open('','_blank','dialog,width=300,height=200,scrollbars=0');
var doc=wnd.document;dp.sh.Utils.CopyStyles(doc,window.document);doc.write(dp.sh.Strings.AboutDialog.replace('{V}',dp.sh.Version));doc.close();wnd.focus();}}
...
//dp.SyntaxHighlighter.ClipboardSwf = '<LINK PARA O RAWGIT DO clipboard.swf>';
